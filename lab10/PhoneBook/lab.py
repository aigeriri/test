...
def importFromCSV():
    with open(r'C:\Users\D16 i7-13700k\Desktop\pp2\lab10\PhoneBook\abc.csv') as file:
...
def importFromXL():
    book=openpyxl.load_workbook(r"C:\Users\D16 i7-13700k\Desktop\pp2\lab10\PhoneBook\abc.xlsx")
    sheet=book.active
...
def queryData():
    ...
    data = cur.fetchall()
    path = r"C:\Users\D16 i7-13700k\Desktop\pp2\lab10\PhoneBook\a.txt"
    for row in data:
        print(row)
    f = open(path, "w")
    for row in data:
